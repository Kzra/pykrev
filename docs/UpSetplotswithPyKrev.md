...
```
    ...
    <matplotlib.legend.Legend at 0x1ffa7148eb0>
...
```
    ...
    <ipython-input-6-6d60e74de00c> in <module>
    ----> 1 from skbio import stats
          2 pcoa_results = stats.ordination.pcoa(bray_curtis,number_of_dimensions = 3)
          3 pcoa_results.perc_exp = np.round((pcoa_results.proportion_explained[0:3]*100),3)
          4 group_names = ['A','B','C']
          5 colours = ['r','g','b']
